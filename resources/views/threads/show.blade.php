    ...
    <thread-view :thread="{{ $thread }}" inline-template>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">                 <span v-text="repliesCount"></span> {{ str_plural('comment', $thread->replies_count) }}.
                            </p>
                            <p>
                                <subscribe-button :active="{{ $thread->isSubscribedTo ? 'true' : 'false' }}" v-if="authorize('signedIn')"></subscribe-button>
